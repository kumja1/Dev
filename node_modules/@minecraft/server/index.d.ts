...
export class Block {
     ...
     * {@link LocationOutOfWorldBoundariesError}
     */
    getComponent<T extends keyof BlockComponentRoute>(componentName: T): BlockComponentRoute[T] | undefined;
    /**
     * @beta
     * @remarks
...
export class BlockPermutation {
     ...
     * permutation has.
     */
    getAllStates(): BlockStateSuperset & Record<`${string}:${string}`, string | number | boolean>;
    /**
     * @beta
     * @remarks
     ...
     * `undefined`.
     */
    getState<R extends keyof BlockStateSuperset>(stateName: R | `${string}:${string}`): R extends keyof BlockStateSuperset ? BlockStateSuperset[R] : (string | number | boolean | undefined);
    /**
     * @beta
     * @remarks
     ...
     */
    matches(blockName: string, states?: BlockStateSuperset & Record<`${string}:${string}`, string | number | boolean>): boolean;
    /**
     * @beta
     * @remarks
     ...
     * @throws This function can throw errors.
     */
    withState<R extends keyof BlockStateSuperset>(name: R | `${string}:${string}`, value: R extends keyof BlockStateSuperset ? BlockStateSuperset[R] : (string | number | boolean)): BlockPermutation;
    /**
     * @remarks
     ...
     * ```
     */
    static resolve(blockName: string, states?: BlockStateSuperset & Record<`${string}:${string}`, string | number | boolean>): BlockPermutation;
}
/**
 * @beta
...
export class Entity {
     ...
     * undefined.
     */
    getComponent<T extends keyof EntityComponentRoute>(componentId: T): EntityComponentRoute[T] | undefined;
    /**
     * @beta
     * @remarks
...
export class ItemStack {
     ...
     * ```
     */
    getComponent<T extends keyof ItemComponentRoute>(componentId: T): ItemComponentRoute[T] | undefined;
    /**
     * @remarks
