...
class BlockPropertiesManager {
     ...
     * with the given ID.
     * @param {Block} block - The ID of the block to set the permutation on.
     ...
     */ 
    addPermutation(block, propertyName, propertyValue) {
      const permutation = BlockPermutation.resolve(block.typeId).withState(propertyName, propertyValue);
     this.setPermutation(block,permutation)
